...
// Type annotations: Code we add to tell Typescript what type of value a variable will refer to. Type annotations are used to define the type of variables, functions, classes, etc. Typescript uses the syntax :type

{
  ...
  //   Here above we have explicitly defined the type of variables
}

// Type inference: Typescript tries to figure out what type of value a variable refers to (Typescript guesses the type) (Typescript uses type inference to give types to variables). Typescript tries to infer types when you don't explicitly annotate them.
...
*/
  ...
  //   Here above we have not explicitly defined the type of variables
}
